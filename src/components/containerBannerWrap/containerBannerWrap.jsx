    ...
    return (
        <div className="contained-banner-wrap container container-border">
            <div ref={ref} className={`contained-banner-box container-width ${inView ? 'in-view' : 'hide-in-view'}`}>
                <div className="label">I'm the right fit</div>
                <div className="title">Get started today</div>
                <div className="subtitle">Whether you want to start building a product or grow your team, You can hire me for Design and Development services tailored to your needs.</div>
            </div>
        </div>
    )
}
