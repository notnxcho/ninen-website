        ...
        <div className='case-content'>
            ...
            <div className="text-block-section-wrap">
                <div className="text-block-content container container-border">
                    ...
                    <div className="description">
                        <p>
                            In developing LiquidStash's platform, I encountered several interrelated design challenges. The project demanded a seamless information architecture that could intuitively present complex financial data to a diverse range of users. This need for clarity had to be balanced with the requirement for a robust, scalable system capable of supporting increasing transaction volumes and data loads.
                        </p>
                        <p>
                            Additionally, simplifying the data visualizations to ensure they were accessible yet informative posed a significant challenge. Equally crucial was the effort to refine and streamline complex workflows, enhancing the overall user experience by reducing operational friction.
                        </p>
                    </div>
                </div>
            </div>
            <div className="text-block-section-wrap">
                <div className="text-block-content container container-border">
                    ...
                    <div className="description">
                        <p>
                            At the heart of our solution was a meticulously crafted UI design for the entire platform. I developed a bespoke design system that not only ensured visual consistency but also embodied LiquidStash's innovative spirit. This custom-tailored approach resulted in an interface that seamlessly blends sophistication with user-friendliness, setting a new standard in financial technology aesthetics.
                        </p>
                        <p>
